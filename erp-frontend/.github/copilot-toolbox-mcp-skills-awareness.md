...
_Generated: 2026-07-31T04:54:06.380Z_
...
Workspace `mcp.json` _(folder: erp-frontend)_

- **c:\Users\adith\Downloads\JAM Enterprises (1)\erp-frontend\.vscode\mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\adith\AppData\Roaming\Code\User\mcp.json** — _File missing_
